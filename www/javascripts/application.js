...
require(['config', 'setup'], function(config){
	...
	if( (controller !== 'drawer') ){
		...
		window.loginView = new steroids.views.WebView({location: 'views/login/put.html', id: 'loginView'});
		window.accessView = new steroids.views.WebView({location: 'views/login/index.html', id: 'accessView'});

		//if(Parse.User.current()){
		if(false){//Dumb but just for now, while we fix the user models
