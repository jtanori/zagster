...
# -- Navigation Bar --
steroids.config.navigationBar.tintColor = "#F9F9F9"
steroids.config.navigationBar.titleColor = "#000000"
steroids.config.navigationBar.buttonTintColor = "#F9F9F9"
steroids.config.navigationBar.buttonTitleColor = "#227CE7"
